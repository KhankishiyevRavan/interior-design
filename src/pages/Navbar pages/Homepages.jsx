        ...
        <div className="container">
          <div className="welcome_interior_text">
            <div className="welcome_interior_text_top">
              ...
              <ul>
                <li>
                  <i className="fa-regular fa-circle-check"></i> Estetik üslubların
                  müxtəlifliyi
                </li>
                <li>
                  <i className="fa-regular fa-circle-check"></i> Rəng çarxı haqqında
                  anlayış
                </li>
                <li>
                  <i className="fa-regular fa-circle-check"></i> Yaradıcı göz və
                  detallara diqqət
                </li>
                <li>
                  <i className="fa-regular fa-circle-check"></i> Davamlı təcrübə
                  haqqında biliklər
                </li>
              </ul>
            </div>
